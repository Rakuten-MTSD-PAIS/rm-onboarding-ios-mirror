...
public enum RMOnboardingSDK {
    ...
    public static func configureJPKI(sessionProvider: SessionProvider) {
        // Ensure SDK is initialized first
        initializeIfNeeded()

        // Configure the JPKI adapter with session provider
        jpkiAdapter?.configure(sessionProvider: sessionProvider)
